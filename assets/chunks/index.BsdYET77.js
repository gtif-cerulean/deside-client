import{f as x,u as $,T as E,x as T,b as y,i as A,r as C}from"./lit-element.Deg-YTNa.js";import{a6 as F,a1 as S,E as b,ab as _,ac as L,ad as R,O as D,h as z}from"./sequential.BHUe01AH.js";import{e as U,i as O,t as I}from"./directive.CvdRHFdJ.js";/**
 * @license
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const P={attribute:!0,type:String,converter:$,reflect:!1,hasChanged:x},M=(o=P,t,e)=>{const{kind:r,metadata:s}=e;let i=globalThis.litPropertyMetadata.get(s);if(i===void 0&&globalThis.litPropertyMetadata.set(s,i=new Map),i.set(e.name,o),r==="accessor"){const{name:c}=e;return{set(l){const m=t.get.call(this);t.set.call(this,l),this.requestUpdate(c,m,o)},init(l){return l!==void 0&&this.P(c,void 0,o),l}}}if(r==="setter"){const{name:c}=e;return function(l){const m=this[c];t.call(this,l),this.requestUpdate(c,m,o)}}throw Error("Unsupported decorator location: "+r)};function h(o){return(t,e)=>typeof e=="object"?M(o,t,e):((r,s,i)=>{const c=s.hasOwnProperty(i);return s.constructor.createProperty(i,c?{...r,wrapped:!0}:r),c?Object.getOwnPropertyDescriptor(s,i):void 0})(o,t,e)}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function j(o,t){return(e,r,s)=>{const i=c=>{var l;return((l=c.renderRoot)==null?void 0:l.querySelector(o))??null};return B(e,r,{get(){return i(this)}})}}class q{constructor(t){this.cle=t}setColorScale(){switch(this.cle.scaleType){case"continuous":this.setContinousColorScale();break;case"discrete":this.setDiscreteColorScale();break;case"threshold":this.setThresholdColorScale();break;case"categorical":this.setCategoricalColorScale();break;default:this.invalidScaleType(this.cle.scaleType)}}setContinousColorScale(){const{interpolator:t,domain:e,range:r}=this.cle;this.colorScale=t?F(t).domain(e):S().range(r).domain(e).interpolate(b)}setDiscreteColorScale(){this.colorScale=_().domain(this.cle.domain).range(this.cle.range)}setThresholdColorScale(){const t=this.cle.domain;this.colorScale=L().domain(t.slice(1,t.length-1)).range(this.cle.range)}setCategoricalColorScale(){this.colorScale=R().domain(this.cle.domain).range(this.cle.range)}invalidScaleType(t){throw new Error(`invalid property scaletype: ${t}.
      Must be one of "categorical", "continuous", "discrete", "threshold".`)}}/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const v=U(class extends O{constructor(o){var t;if(super(o),o.type!==I.ATTRIBUTE||o.name!=="class"||((t=o.strings)==null?void 0:t.length)>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(o){return" "+Object.keys(o).filter(t=>o[t]).join(" ")+" "}update(o,[t]){var r,s;if(this.st===void 0){this.st=new Set,o.strings!==void 0&&(this.nt=new Set(o.strings.join(" ").split(/\s/).filter(i=>i!=="")));for(const i in t)t[i]&&!((r=this.nt)!=null&&r.has(i))&&this.st.add(i);return this.render(t)}const e=o.element.classList;for(const i of this.st)i in t||(e.remove(i),this.st.delete(i));for(const i in t){const c=!!t[i];c===this.st.has(i)||(s=this.nt)!=null&&s.has(i)||(c?(e.add(i),this.st.add(i)):(e.remove(i),this.st.delete(i)))}return E}});class G{constructor(t){this.cle=t}render(){const t=this.cle.titleText?T`<p class="legend-title">${this.cle.titleText}</p>`:"",e={hidden:this.cle.scaleType==="categorical"},r={hidden:this.cle.scaleType!=="categorical","categorical-container":!0};return T`<div
      class="cle-container"
    ...
    >
      ...
      <slot name="footer"></slot>
        ...
        >
          ${i}
        </li>`)}`}renderContinuous(){var d;if(this.cle.scaleType!=="continuous"||this.cle.colorScale===null)return"";const{colorScale:t,marginTop:e,marginLeft:r,marginRight:s,tickSize:i,width:c,range:l}=this.cle,m=this.cle.marginBottom+i,p=this.cle.height+i,u=((d=t.interpolator)==null?void 0:d.call(t))||D(b,l);return y`<image
      x=${r}
      y=${e}
      width=${c-s-r}
      height=${p-e-m}
